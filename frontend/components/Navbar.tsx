...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    // Load saved theme
    const saved = localStorage.getItem('etnewsai_theme') as 'light' | 'dark' | null;
    if (saved) {
      setTheme(saved);
            ...
            <>
              ...
              {dropdownOpen && (
                <div className="user-dropdown">
                  ...
                  <button className="dropdown-item" onClick={handleRefreshFeed}>
                    Refresh feed
                  </button>
                  <button className="dropdown-item danger" onClick={handleChangeUser}>
                    Change user
                  </button>
                </div>
              )}
